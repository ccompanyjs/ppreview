#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\users\\damian\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.226\\out\\buildhook\\index.js').default({tool: 'live-server'}); } catch(cjsError) { try { import('file:///c:/users/damian/.vscode/extensions/wallabyjs.console-ninja-0.0.226/out/buildhook/index.js').then(m => m.default.default({tool: 'live-server'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
